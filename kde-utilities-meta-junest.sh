...
kcodecs kcontacts kdbusaddons kservice ktextwidgets kvantum libakonadi qt6ct $kajongg_deps"
...
cp archlinux/.junest/usr/share/icons/hicolor/128x128/apps/ark* "$APP".AppDir/ 2>/dev/null
echo "[Desktop Entry]
Name=kdeutils
Exec=AppRun
Icon=ark
